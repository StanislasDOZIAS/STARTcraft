...
void Actions::ExpendBase_1(UnitCount& myUnits, std::list<Squad*>& mySquads) {
    ...
    int ActionId = 1;
    bool gaz_created = false;
    bool mineral_created = false;
    Squad *gaz;
    Squad *mineral;
    ...
    if (Extractor != nullptr) {
        ...
        //gaz = getSquad(1, 1, mySquads, myUnits, 4);
        gaz_created = true;
    }
    /*
    if (gaz_created && Extractor->getType() == BWAPI::UnitTypes::Zerg_Extractor) {
        for (BWAPI::Unit u : gaz.get_Units()) {
            u->rightClick(Extractor);
        }
    }*/
    /*
    myUnits.droneWanted = 20;
    myUnits.hydraWanted = 20;
    myUnits.lurkerWanted = 20;
    myUnits.zerglingWanted = 40;
    */
...
void Actions::BaseArmy(UnitCount& myUnits, std::list<Squad*>& mySquads) {
    Squad* Zerglings;
    int ActionId = 2;
    Zerglings = getSquad(2, ActionId, mySquads, myUnits, 40);
}
